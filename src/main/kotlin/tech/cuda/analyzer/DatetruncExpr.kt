...
class DatetruncExpr(
    ...
    override fun rewriteWithTargetList(targetList: MutableList<TargetEntry>): Expression {
        return DatetruncExpr(columnInfo, hasAgg, field,
    ...
    override fun deepCopy(): Expression {
        return DatetruncExpr(columnInfo, hasAgg, field, fromExpr.deepCopy())
    }
    ...
    override fun toString(): String {
        return "DATE_TRUNC($field, f$fromExpr)"
    }
